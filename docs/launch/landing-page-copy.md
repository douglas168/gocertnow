...
1. Hero (pass guarantee + AI tutor + founder authority)
2. The problem (3 pain points)
3. The four things LevelCert does that no-one else does
...
## 2. 你是不是也遇到這些問題？（The problem block）

### 區塊標題

> **為什麼大多數人準備 iPAS AI 考試都失敗？**

### 痛點 1

> **下班只剩 1–2 小時，實體週末班根本去不了**
> 你看過那些課程 — 臺北實體課、週末整天、一堂 NT$8,000 起跳。你下班回家只想癱著，誰還有力氣搭車跨城市上課？

### 痛點 2

> **影片課程 30 天就過期，你根本來不及看完**
> 買了線上課程，結果影片有觀看期限。你還沒看完第二章，權限就沒了。錢花了，書沒讀完，考試還是沒把握。

### 痛點 3

> **模擬題只告訴你 A 對 B 錯，不告訴你為什麼**
> 你做了 100 題模擬題，對了 60 題。剩下的 40 題你知道哪些是粗心、哪些是觀念錯、哪些是整個章節沒讀懂嗎？不知道，因為沒人解釋。

---

## 3. LevelCert 和市面上的課程有什麼不同？（Four moats block）
...
> 24/7 上線，想什麼時候讀都可以。**創始 / 早鳥會員完整課程存取至 2026 年底**，保證至少能參加 2 次正式考試（8/15、11/7）。考不過？再延長 6 個月到下次考試，免費。
> 對比：Tiandiren 影片 30 天過期，其他多數為固定時段實體班。

#### 卡片 2：**AI 家教為你逐題解析**

> 每一題錯了，AI 會用你能聽懂的方式解釋。不只告訴你正確答案 — 而是告訴你為什麼你的思路錯了，哪裡的觀念要補強。
> 對比：一般模擬考只給你「A 是對的」四個字。

#### 卡片 3：**弱點雷達圖**

> 模擬考完自動產生你的弱點分析。哪一科目拖後腿、哪個子題型常錯、要複習哪幾課 — 全部視覺化。不用自己猜。
> 對比：其他課程沒有這個功能。

#### 卡片 4：**不過延長 6 個月**

> 考不過？把官方失敗通知信轉寄給我們，我們自動幫你延長 6 個月存取時間 — 確保你趕得上下次考試。
> 對比：沒有任何一家課程敢給你這個保證。
...
| 方案 | 價格 | 適用對象 | 剩餘名額 |
|---|---|---|---|
| **創始會員** | **NT$1,980** | 前 20 名購買者 | XX / 20 |
| **學生方案** | **NT$1,480** | 大學/研究所學生（需驗證） | 本季剩 XX 席 |
| **早鳥價** | NT$2,980 | 創始會員滿額後 | — |
| **正式價** | NT$3,980 | 早鳥結束後 | — |

### 每個方案包含

> - 完整 iPAS AI 應用規劃師初級課程（4 大主題，X 堂課）
> - 無限次模擬考 + 弱點分析
> - AI 家教逐題解析
> - **創始 / 早鳥 / 學生 / 社團方案：完整課程存取至 2026 年 12 月 31 日**（保證至少能參加 8/15、11/7 兩次正式考試）
> - **考不過？免費延長 6 個月到下次考試**
> - 創始會員限定：創辦人私人 LINE，任何問題直接問我
> - 創始會員限定：價格永久鎖定（未來所有 LevelCert 課程享創始會員價）

### 大學社團團購（加強版）

> **[社團名稱] 專屬團購方案**
> 20 人以上團購：**NT$1,200 / 人**
> 包含：社團專屬討論群 + 創辦人線上 Q&A 一場 + 考試通過率追蹤
> 社團代表請寄信到 [EMAIL] 或加 LINE: [LINE_ID]

### 學生驗證方式

> 使用 .edu.tw 學校信箱結帳，或結帳後私訊學生證照片（可打碼姓名）即可。

### Pricing CTA

> **🔥 立即以 NT$1,980 加入創始會員 → [Pre-order button]**
...
> 把官方 iPAS 的失敗通知信（從你報名時使用的信箱）轉寄到 [EMAIL]，我們會自動延長你的課程存取 6 個月，讓你趕得上下一次考試。完全免費，無需重買。第二次還是沒過？我們提供 50% 折扣碼讓你重新購買。

### Q2：影片有沒有觀看期限？

> **創始 / 早鳥 / 學生 / 社團方案一律享有到 2026 年 12 月 31 日的完整存取** — 保證你至少能參加 2026 年 8/15 和 11/7 兩次正式 iPAS 初級考試（因為今年 4/10 中午 12 點前沒報名的話，5/16 那次來不及）。考不過？再延長 6 個月到下一次考試（需轉寄官方失敗通知）。正價（第 71 位之後）回歸標準 3 個月存取 + 6 個月考不過延長。這比市面上 30 天限制的課程好太多了。

### Q3：和 [競品名] 有什麼差別？

> 最核心的三個差別：
> 1. 我們完全自學，沒有固定上課時間
> 2. 我們有 AI 逐題解析，不是只有 A/B/C/D 答案
> 3. 我們有「考不過延長 6 個月」的保證
...
> 可以。點上面的「免費診斷考試（20 題）」— 你會拿到一份完整的弱點分析報告，看到 LevelCert 的模擬考和 AI 解題長什麼樣子。不用註冊，不用付錢。

### Q6：我是學生，怎麼證明身份？

> 兩種方式：(1) 用你的 .edu.tw 信箱結帳，或 (2) 結帳後私訊我們學生證照片（可以打碼姓名，只露出學校和有效期）。學生價每季限 50 席。

### Q7：付款方式？

> 信用卡（Stripe）、LINE Pay、街口支付。創始階段（前 20 名）暫時先用轉帳，付款後我會親自用 LINE 確認你的帳號。
...
> **下一次 iPAS AI 考試不等人。**
> **現在以創始會員價 NT$1,980 加入 — 比正式價便宜一半。**
>
> [立即加入創始會員 → Pre-order button]
>
> 還在猶豫？[先做免費診斷看看自己的程度 → Free diagnostic button]

### Footer

> LevelCert — 為認真想通過認證的你而生
>
> 聯絡：[EMAIL] | LINE: [LINE_ID]
>
> © 2026 LevelCert. Built with coffee and one failed attempt to find a decent AI cert course in Taiwan.
...
### What to iterate after Week 2

- After collecting 10 customer quotes in `docs/customer-quotes.md`, rewrite the 3 pain points using the actual verbatim complaints you found.
- After the first 5 buyers tell you *"what almost stopped you,"* rewrite the FAQ from those objections.
- After the first alumni pass, move their quote to the top of the page above the founder section.

### What NOT to include (hard cuts)
...
Carrd pages should scroll in 3–4 mobile screens. If this copy is too long, cut in this order:
1. Cut Q3, Q7, Q8 from FAQ
2. Cut competitor table from pricing section
3. Shrink founder section to 3 sentences
4. Never cut: hero, pass guarantee, founder photo, pricing, free diagnostic CTA
