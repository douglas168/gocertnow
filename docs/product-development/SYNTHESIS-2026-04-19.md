...
- **Conflicts with your frozen operating rules.** Perplexity's stack (streaks → XP/levels → progress bars → guilds → badges) contradicts `docs/_todo/START-HERE.md` anti-distractions and `docs/product-development/RPG-LITE-SCOPE.md` ("no leveling system in Phase 1," "RPG is a layer, not the identity").
